...
public class SymmetricEncryptionUtils {
    ...
    public static byte[] encryptWithAES(String plainText, SecretKey secretKey,
    ...
    public static String decryptWithAES(byte[] cipherText, SecretKey secretKey,
                                        byte[] initializationVector) throws
